...
const questions = [
    ...
    {
        question: "Which of the following is even number?",
        options: ["3", "4", "5", "7"],
        correctAnswer: "B"
    },
    {
        question: "Which of the following is odd number?",
        options: ["3", "4", "8", "6"],
        correctAnswer: "A"
    },
    {
...
function nextQuestion() {
    ...
    if (currentQuestion < questions.length) {
        ...
        quizCompletedElement.textContent = "Congratulations, Quiz Completed!";
